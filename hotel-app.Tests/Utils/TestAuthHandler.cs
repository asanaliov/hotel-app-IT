...
public class TestAuthHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    ...
    {
        public static readonly string UserId = "test-guest-1";
        public static readonly string AdminId = "test-admin-id";
        public static readonly string UserEmail = "user@test.com";
        public static readonly string AdminEmail = "admin@test.com";
    ...
    protected override Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        {
            return Task.FromResult(AuthenticateResult.NoResult()); // <- Trigger redirect
        }
